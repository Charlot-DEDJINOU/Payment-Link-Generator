<div class='resquesttopaysuccessful d-flex flex-column justify-content-center align-items-center'>
    ...
    <img class='mb-4 img-fluid w-25' src='{{ asset('assets/yl_success.png') }}' alt='' width='72' height='57'>
    <div class='paymentbox container'>
        ...
        <div class='form-floating mb-3'>
            <input type='tel' class='form-control shadow-none border-none' id='phone' name='phone' pattern='[0-9]{3}[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}' value='{{ $transaction->numero }}' readonly>
        ...
        <div class='form-floating mb-3'>
            <input type='text' class='form-control payid shadow-none border-none' id='floatingInput' name='externalId' placeholder='Statut' value='{{ $transaction->id_payement }}' readonly>
