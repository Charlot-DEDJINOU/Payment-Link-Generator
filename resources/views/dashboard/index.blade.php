            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">ID de Paiement</th>
                ...
                <tbody>
                    @foreach ($transactions as $transaction)
                        <tr>
                            ...
                            <td class="text-center">{{  $transaction->id_payement }}</td>
                            ...
                            <td class="text-center">
                                <a href="{{ route('dashboard.transaction', ['id_generate' => $transaction->id_generate])}}" class="text-decoration-none btn btn-success text-white mx-2 text-center">
